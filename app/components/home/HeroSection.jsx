...
const HeroSection = () => {
  return (
    <section className="hero-area bg-cover" style={{backgroundImage: `url(/images/banner.webp)`}}>
      <Container>
        <div className="row align-items-center justify-content-between">
          <div className="col-lg-6 pl-lg-0 text-center text-lg-left">
            ...
            <Link href="/" className="btn btn-primary" data-aos="fade-up" data-aos-delay="1400">Get Agico</Link>
          </div>
          <div className="col-lg-5 pl-lg-0 pt-5 pt-lg-0 text-lg-right text-center">
            <Image height={472} width={543} src="/images/banner-1.webp" className="img-fluid" alt="banner-image for home page" data-aos="zoom-in" data-aos-delay="1500" />
          </div>
        </div>
      </Container>
    </section>
